 ...
 */
package org.apache.beam.examples.complete.kafkatomysql.kafka.consumer;
...
public class Utils {
  ...
  public static Map<String, String> configureSsl(KafkaToMysqlOptions options) {
  ...
  public static boolean isSslSpecified(KafkaToMysqlOptions options) {
